        ...
        <footer class="bg-gray-50">
            <div class="mx-auto grid max-w-screen-xl gap-y-8 gap-x-12 px-4 py-10 md:grid-cols-2 xl:grid-cols-4 xl:px-10">
                <div class="max-w-sm">
                    <div class="mb-6 flex h-12 items-center space-x-2">
                        <span class="text-2xl font-bold">UB<span class="text-blue-600">Merch</span>.</span>
                    </div>
                    <div class="text-gray-500">Elevate your university experience with UB Merch. Shop our unique and stylish merchandise, perfect for students, alumni, and fans!</div>
                </div>
                <div class="">
                    <div class="mt-4 mb-2 font-medium xl:mb-4">Address</div>
                    <div class="text-gray-500">
                        Gedung Utara Asrama Mahasiswa, <br>Jl. GOR Pertamina Universitas Brawijaya Jl. Veteran No.Depan, Ketawanggede, Kec. Lowokwaru, Kota Malang, Jawa Timur 65145, <br />                
                    </div>
                </div>
                <div class="">
                    ...
                    <nav aria-label="Footer Navigation" class="text-gray-500">
                        <ul class="space-y-3">
                            <li><a class="hover:text-blue-600 hover:underline" href="product">Pricing</a></li>
            ...
            <div class="bg-gray-100">
                <div class="mx-auto flex max-w-screen-xl flex-col gap-y-4 px-4 py-3 text-center text-gray-500 sm:flex-row sm:justify-between sm:text-left">
                    <div class="">© 2024 UBMerch | All Rights Reserved</div>
                    <div class="">
