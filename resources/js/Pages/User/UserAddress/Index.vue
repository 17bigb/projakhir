        ...
        <div class="h-screen pt-10">
            <section class="bg-gray-50 p-3 sm:p-5">
                ...
                <el-dialog
                    ...
                    width="60%"
                >
                    <h3 class="text-lg text-gray-800 mb-6">{{ isEditItem ? 'Edit Address' : 'Add Address' }}</h3>
                    ...
                    <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                            ...
                            <div class="w-full md:w-1/2">
                                <form class="flex items-center">
                                    ...
                                    <div class="relative w-full">
                                        ...
                                        <input type="text" v-model.lazy="search" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2" placeholder="Search" required="">
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500">
                                ...
                                <tbody>
                                <tr v-for="(item, index) in address.data" :key="item.id" class="border-b">
                                    <td class="px-4 py-3">{{index+1}}</td>
                                    <td scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">{{item.address1}}</td>
                                    <td scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">{{item.no_hp}}</td>
                                    <td scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">{{item.province}}</td>
                                    <td scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">{{item.city}}</td>
                                    <td scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">{{item.country_code}}</td>
                                    <td scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap capitalize">
                                        {{item.type}}
                                    </td>
                                    <td scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap capitalize">
                                        <span v-if="item.isMain" class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded">Main Address</span>
                                        <span v-else class="bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded">Secondary Address</span>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div :id="`${item.id}`"
                                            ...
                                            <div class="py-1">
                                                <a href="#" @click="deleteAddress(item, index)" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
