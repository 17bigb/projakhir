...
<template>
    <section class="bg-gray-50 p-3 sm:p-5">
        ...
        <el-dialog
            ...
            width="30%"
        >
            <h3 class="text-lg text-gray-800 mb-6">{{ isEditItem ? 'Edit Category' : 'Add Category' }}</h3>
            <form @submit.prevent="isEditItem ? updateCategory() : AddCategory()">
                <div class="mb-6">
                    ...
                    <input type="text" v-model="name" name="name" id="form_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Category name" required>
                </div>
                <div class="mt-6">
            ...
            <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="search" v-model.lazy="search" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2" placeholder="Search" required="">
                            </div>
                        </form>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                        <tr v-for="(item, index) in categories.data" :key="item.id" class="border-b">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div :id="`${item.id}`"
                                    ...
                                    <div class="py-1">
                                        <a href="#" @click="deleteCategory(item, index)" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
