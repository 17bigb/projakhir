...
<template>
    <section class="bg-gray-50 p-3 sm:p-5">
        ...
        <el-dialog
            ...
            width="30%"
        >
            <h3 class="text-lg text-gray-800 mb-6">{{ isEditItem ? 'Edit Brand' : 'Add Brand' }}</h3>
            <form @submit.prevent="isEditItem ? updateBrand() : AddBrand()">
                <div class="mb-6">
                    ...
                    <input type="text" v-model="name" name="name" id="form_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Brand name" required>
                </div>
                <div class="mt-6">
            ...
            <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                        <tr v-for="(item, index) in brands.data" :key="item.id" class="border-b">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div :id="`${item.id}`"
                                    ...
                                    <div class="py-1">
                                        <a href="#" @click="deleteBrand(item, index)" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
