...
<template>
    <AdminLayout>
        ...
        <div class="flex w-full">
            <section class="flex w-full bg-gray-50 p-3 sm:p-5">
                    ...
                    <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500">
                                ...
                                <tbody>
                                <tr v-for="(order, i) in orders.data" class="border-b">
                                    ...
                                    <td class="px-4 py-3">
                                        <span v-if="order.status == 'Paid'" class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded">Paid</span>
                                        <span v-else class="bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded">Unpaid</span>
                                    </td>
