        ...
        <div class="py-10">
            <div class="bg-white rounded-lg shadow-lg px-8 py-10 max-w-xl mx-auto">
                ...
                <div class="flex justify-center">
                    <Link :href="route('admin.order.index')" class="text-white bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Back</Link>
                </div>
            </div>
        </div>
    </App>
