...
<template>
    <section class="bg-gray-50 p-3 sm:p-5">
        ...
        <el-dialog
            ...
            width="30%"
        >
            <h3 class="text-lg text-gray-800 mb-6">{{ isEditItem ? 'Edit Banner' : 'Add Banner' }}</h3>
            <form @submit.prevent="isEditItem ? updateBanner() : AddBanner()">
                        <div class="mb-6">
                            <label for="form_name" class="block mb-2 text-sm font-medium text-gray-900">Name</label>
                            <input type="text" v-model="name" name="name" id="form_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Banner name" required>
                        </div>
                        <div class="mb-6">
                            <label for="form_active" class="block mb-2 text-sm font-medium text-gray-900">Status</label>
                            <select id="form_active" name="form_active" v-model="isActive" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <div class="mt-6">
                        ...
                        <div v-if="image" class="flex flex-nowrap mb-8 ">
                            <div class="relative w-32 h-32 ">
                                ...
                                <span
                                    class="absolute top-0 -right-2 transform -translate-y-1/2 w-6 h-6 bg-red-400 border-2 border-white rounded-full">
            ...
            <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                        <tr v-for="(item, index) in banners.data" :key="item.id" class="border-b">
                            ...
                            <td class="px-4 py-3">
                                <td class="px-4 py-3">
                                    <span v-if="item.isActive == 1" class="bg-green-100 text-green-800 flex w-20 justify-center items-center text-xs font-medium me-2 px-2 py-1 rounded">Active</span>
                                    <span v-else class="bg-red-100 text-red-800 flex w-20 justify-center items-center text-xs font-medium me-2 px-2 py-1 rounded">Non Active</span>
                                </td>
                            </td>
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div :id="`${item.id}`"
                                    ...
                                    <div class="py-1">
                                        <a href="#" @click="deleteBanner(item, index)" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
